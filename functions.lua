...
local function loadMount(mountID, spellFlag, links)
...
local function loadSpells(spells)
    ...
    for _, spellPair in ipairs(spells) do
        ...
        loadMount(spellPair[1], spellPair[2], links)
    end

    return links
end

local function updateMountSpells()
    return loadSpells(addonTable.mounts)
end

local function updateSpells()
    return loadSpells(addonTable.spells)
end

-- ==== EXPORT ====
addonTable.itemLinks = {}
addonTable.updateItems = updateItems
addonTable.updateMountSpells = updateMountSpells
addonTable.updateSpells = updateSpells
